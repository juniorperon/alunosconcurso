...
<form method="post" action="processa_curso.php">
    ...
    <input class = "form-control" type="text" name="carga_horaria" placeholder="Insira a duracao do curso">
    <br><br>
    ...
    <?php while ($linha = mysqli_fetch_array($consulta_cursos)){ ?>
        <?php  if($linha['id_curso'] == $_GET['editar']){ ?>
            ...
            <form method="post" action="edita_curso.php">
                ...
                <br><br>
                <label class = "badge badge-secondary">Carga Horária:</label><br>
                <input class = "form-control" type="text" name="carga_horaria" placeholder="Insira a duracao do curso" value="<?php echo $linha['carga_horaria']; ?>">
                <br><br>
